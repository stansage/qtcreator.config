...
QtModule {
    ...
    staticLibsRelease: []
    dynamicLibsDebug: []
    dynamicLibsRelease: ["/opt/vega-nvr/lib/libQt5Qml.so.5.10.0", "/opt/vega-nvr/lib/libQt5Gui.so.5.10.0", "/opt/vega-nvr/lib/libQt5Network.so.5.10.0", "/opt/vega-nvr/lib/libQt5Core.so.5.10.0", "pthread"]
    linkerFlagsDebug: []
    linkerFlagsRelease: []
    frameworksDebug: []
    frameworksRelease: []
    ...
    libFilePathDebug: ""
    libFilePathRelease: "/opt/vega-nvr/lib/libQt5Quick.so.5.10.0"
    cpp.defines: {
    ...
    cpp.includePaths: ["/opt/vega-nvr/include", "/opt/vega-nvr/include/QtQuick"]
    cpp.libraryPaths: ["/usr/X11R6/lib64", "/opt/vega-nvr/lib", "/opt/vega-nvr/lib"]
    property bool qmlDebugging: false
    property string qmlPath: "/opt/vega-nvr/qml"
    property string qmlImportsPath: "/opt/vega-nvr/imports"
