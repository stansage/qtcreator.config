...
Module {
    ...
    property path docPath: "/opt/vega-nvr/doc"
    ...
    property string libFilePathRelease: "/opt/vega-nvr/lib/libQt5Core.so.5.10.0"
    ...
    cpp.includePaths: {
        var paths = ["/opt/vega-nvr/include", "/opt/vega-nvr/include/QtCore"];
