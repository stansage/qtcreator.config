...
QtModule {
    ...
    libFilePathDebug: ""
    libFilePathRelease: "/opt/poky/2.4.3/sysroots/corei7-64-poky-linux/usr/lib/libQt5DesignerComponents.so.5.9.6"
    cpp.defines: ["QT_DESIGNERCOMPONENTS_LIB"]
    cpp.includePaths: ["/opt/poky/2.4.3/sysroots/corei7-64-poky-linux/usr/include/qt5", "/opt/poky/2.4.3/sysroots/corei7-64-poky-linux/usr/include/qt5/QtDesignerComponents", "/opt/poky/2.4.3/sysroots/corei7-64-poky-linux/usr/include/qt5/QtDesignerComponents/5.9.6", "/opt/poky/2.4.3/sysroots/corei7-64-poky-linux/usr/include/qt5/QtDesignerComponents/5.9.6/QtDesignerComponents"]
    cpp.libraryPaths: []
