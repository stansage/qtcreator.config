...
QtModule {
    ...
    libFilePathDebug: ""
    libFilePathRelease: "/opt/poky/2.4.3/sysroots/corei7-64-poky-linux/usr/lib/libQt5QuickTemplates2.so.5.9.6"
    cpp.defines: ["QT_QUICKTEMPLATES2_LIB"]
    cpp.includePaths: ["/opt/poky/2.4.3/sysroots/corei7-64-poky-linux/usr/include/qt5", "/opt/poky/2.4.3/sysroots/corei7-64-poky-linux/usr/include/qt5/QtQuickTemplates2", "/opt/poky/2.4.3/sysroots/corei7-64-poky-linux/usr/include/qt5/QtQuickTemplates2/5.9.6", "/opt/poky/2.4.3/sysroots/corei7-64-poky-linux/usr/include/qt5/QtQuickTemplates2/5.9.6/QtQuickTemplates2"]
    cpp.libraryPaths: []
