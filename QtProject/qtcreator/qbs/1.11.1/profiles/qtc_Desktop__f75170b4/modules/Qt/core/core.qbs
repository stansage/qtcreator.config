...
Module {
    ...
    property path docPath: "/opt/Qt/Docs/Qt-5.9.6"
    ...
    property string libFilePathRelease: "/opt/Qt/5.9.6/gcc_64/lib/libQt5Core.so.5.9.6"
    ...
    cpp.includePaths: {
        var paths = ["/opt/Qt/5.9.6/gcc_64/include", "/opt/Qt/5.9.6/gcc_64/include/QtCore"];
