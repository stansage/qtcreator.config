...
QtModule {
    ...
    libFilePathDebug: ""
    libFilePathRelease: "/opt/Qt/5.10.0/gcc_64/lib/libQt5Purchasing.so.5.10.0"
    cpp.defines: ["QT_PURCHASING_LIB"]
    cpp.includePaths: ["/opt/Qt/5.10.0/gcc_64/include", "/opt/Qt/5.10.0/gcc_64/include/QtPurchasing"]
