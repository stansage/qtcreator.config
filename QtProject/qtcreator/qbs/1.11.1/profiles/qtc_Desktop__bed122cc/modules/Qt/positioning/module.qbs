...
QtModule {
    ...
    libFilePathDebug: ""
    libFilePathRelease: "/opt/Qt/5.10.1/gcc_64/lib/libQt5Positioning.so.5.10.1"
    cpp.defines: ["QT_POSITIONING_LIB"]
    cpp.includePaths: ["/opt/Qt/5.10.1/gcc_64/include", "/opt/Qt/5.10.1/gcc_64/include/QtPositioning"]
