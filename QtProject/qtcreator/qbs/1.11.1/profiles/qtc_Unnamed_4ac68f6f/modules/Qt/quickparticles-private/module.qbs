...
QtModule {
    ...
    libFilePathDebug: ""
    libFilePathRelease: "/opt/poky/2.4.2/sysroots/corei7-64-poky-linux/usr/lib/libQt5QuickParticles.so.5.9.6"
    cpp.defines: ["QT_QUICKPARTICLES_LIB"]
    cpp.includePaths: ["/opt/poky/2.4.2/sysroots/corei7-64-poky-linux/usr/include/qt5", "/opt/poky/2.4.2/sysroots/corei7-64-poky-linux/usr/include/qt5/QtQuickParticles", "/opt/poky/2.4.2/sysroots/corei7-64-poky-linux/usr/include/qt5/QtQuickParticles/5.9.6", "/opt/poky/2.4.2/sysroots/corei7-64-poky-linux/usr/include/qt5/QtQuickParticles/5.9.6/QtQuickParticles"]
    cpp.libraryPaths: []
