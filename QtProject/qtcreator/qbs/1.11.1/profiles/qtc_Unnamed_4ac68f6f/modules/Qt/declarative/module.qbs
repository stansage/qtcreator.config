...
QtModule {
    ...
    libFilePathDebug: ""
    libFilePathRelease: "/opt/poky/2.4.2/sysroots/corei7-64-poky-linux/usr/lib/libQt5Declarative.so.5.8.0"
    cpp.defines: {
    ...
    cpp.includePaths: ["/opt/poky/2.4.2/sysroots/corei7-64-poky-linux/usr/include/qt5", "/opt/poky/2.4.2/sysroots/corei7-64-poky-linux/usr/include/qt5/QtDeclarative"]
    cpp.libraryPaths: []
    property bool qmlDebugging: false
    property string qmlPath: "/opt/poky/2.4.2/sysroots/corei7-64-poky-linux/usr/lib/qt5/qml"
    property string qmlImportsPath: "/opt/poky/2.4.2/sysroots/corei7-64-poky-linux/usr/lib/qt5/imports"
}
