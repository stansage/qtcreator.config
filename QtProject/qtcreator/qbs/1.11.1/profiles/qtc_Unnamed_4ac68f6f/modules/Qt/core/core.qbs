...
Module {
    ...
    property stringList qtConfig: ["shared", "release", "c++11", "c++14", "c++1z", "concurrent", "dbus", "no-qml-debug", "reduce_exports", "reduce_relocations", "stl", "assimp", "properties", "animation", "textcodec", "big_codecs", "clock-monotonic", "codecs", "textdate", "datestring", "doubleconversion", "eventfd", "filesystemiterator", "filesystemwatcher", "gestures", "glib", "itemmodel", "proxymodel", "identityproxymodel", "inotify", "library", "mimetype", "process", "statemachine", "regularexpression", "settings", "sharedmemory", "sortfilterproxymodel", "stringlistmodel", "systemsemaphore", "temporaryfile", "threadsafe-cloexec", "translation", "xmlstream", "xmlstreamreader", "xmlstreamwriter", "action", "clipboard", "colornames", "cssparser", "cursor", "desktopservices", "imageformat_xpm", "draganddrop", "opengl", "egl", "freetype", "highdpiscaling", "im", "image_heuristic_mask", "image_text", "imageformat_bmp", "imageformat_jpeg", "imageformat_png", "imageformat_ppm", "imageformat_xbm", "imageformatplugin", "movie", "pdf", "picture", "shortcut", "standarditemmodel", "systemtrayicon", "tabletevent", "texthtmlparser", "textodfwriter", "validator", "whatsthis", "wheelevent", "alsa", "pulseaudio", "networkinterface", "bearermanagement", "ftp", "getaddrinfo", "getifaddrs", "http", "ipv6ifname", "localserver", "networkdiskcache", "networkproxy", "openssl", "socks5", "ssl", "udpsocket", "printer", "printdialog", "printpreviewwidget", "printpreviewdialog", "groupbox", "buttongroup", "menu", "lineedit", "spinbox", "slider", "scrollbar", "scrollarea", "itemviews", "tableview", "toolbutton", "calendarwidget", "colordialog", "listview", "columnview", "combobox", "completer", "contextmenu", "datawidgetmapper", "datetimeedit", "dial", "filesystemmodel", "dirmodel", "resizehandler", "mainwindow", "dockwidget", "textedit", "errormessage", "splitter", "stackedwidget", "treeview", "filedialog", "fontcombobox", "fontdialog", "fscompleter", "graphicsview", "graphicseffect", "inputdialog", "keysequenceedit", "lcdnumber", "listwidget", "mdiarea", "menubar", "messagebox", "paint_debug", "progressbar", "progressdialog", "rubberband", "sizegrip", "splashscreen", "statusbar", "statustip", "style-stylesheet", "syntaxhighlighter", "tabbar", "tablewidget", "tabwidget", "textbrowser", "toolbar", "toolbox", "tooltip", "treewidget", "undocommand", "undostack", "undogroup", "undoview", "wizard", "dom"]
    property path binPath: "/opt/poky/2.4.2/sysroots/x86_64-pokysdk-linux/usr/bin/qt5"
    property path incPath: "/opt/poky/2.4.2/sysroots/corei7-64-poky-linux/usr/include/qt5"
    property path libPath: "/opt/poky/2.4.2/sysroots/corei7-64-poky-linux/usr/lib"
    property path pluginPath: "/opt/poky/2.4.2/sysroots/corei7-64-poky-linux/usr/lib/qt5/plugins"
    property string mkspecName: "linux-oe-g++"
    property path mkspecPath: "/opt/poky/2.4.2/sysroots/corei7-64-poky-linux/usr/lib/qt5/mkspecs/linux-oe-g++"
    ...
    property path docPath: "/opt/poky/2.4.2/sysroots/corei7-64-poky-linux/usr/share/doc/qt5"
    ...
    property string libFilePathRelease: "/opt/poky/2.4.2/sysroots/corei7-64-poky-linux/usr/lib/libQt5Core.so.5.9.6"
    ...
    cpp.includePaths: {
        var paths = ["/opt/poky/2.4.2/sysroots/corei7-64-poky-linux/usr/include/qt5", "/opt/poky/2.4.2/sysroots/corei7-64-poky-linux/usr/include/qt5/QtCore"];
