...
Module {
    ...
    property path docPath: "/opt/Qt/Docs/Qt-5.11.0"
    ...
    property string libFilePathRelease: "/opt/Qt/5.11.0/gcc_64/lib/libQt5Core.so.5.11.0"
    ...
    cpp.includePaths: {
        var paths = ["/opt/Qt/5.11.0/gcc_64/include", "/opt/Qt/5.11.0/gcc_64/include/QtCore"];
